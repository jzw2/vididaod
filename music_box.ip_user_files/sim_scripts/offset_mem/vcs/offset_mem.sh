...
#
# Generated by Vivado on Wed Dec 05 15:41:50 CST 2018
...
# executing this script. Please type 'offset_mem.sh -help' for more information.
#
...
reset_run()
{
  files_to_remove=(ucli.key offset_mem_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log 64 AN.DB csrc offset_mem_simv.daidir)
...
compile()
{
  ...
  vhdlan -work xil_defaultlib $opts_vhd \
    "$ref_dir/../../../../music_box.srcs/sources_1/ip/offset_mem/sim/offset_mem.vhd" \
  2>&1 | tee -a vhdlan.log
...
elaborate()
{
  ...
  vcs $opts xil_defaultlib.offset_mem -o offset_mem_simv
}
...
simulate()
{
  ...
  ./offset_mem_simv $opts -do simulate.do
}
# Script usage
usage()
{
