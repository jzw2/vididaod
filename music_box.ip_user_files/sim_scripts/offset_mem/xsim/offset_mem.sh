...
elaborate()
{
  xelab --relax --debug typical --mt auto -wto b500bd346b0149adb8c4abe2bee709e8 -m64 -L blk_mem_gen_v8_3_1 -L xil_defaultlib -L secureip --snapshot offset_mem xil_defaultlib.offset_mem -log elaborate.log
}
