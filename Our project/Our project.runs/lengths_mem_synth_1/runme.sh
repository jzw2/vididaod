...
HD_PWD='/home/kristbp2/cs296-33fa18-secret/Our project/Our project.runs/lengths_mem_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lengths_mem.vds -m64 -mode batch -messageDb vivado.pb -notrace -source lengths_mem.tcl
