...
HD_PWD='/home/kristbp2/cs296-33fa18-secret/music_box.runs/square_wave_mem_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log square_wave_mem.vds -m64 -mode batch -messageDb vivado.pb -notrace -source square_wave_mem.tcl
