...
HD_PWD='/home/kristbp2/cs296-33fa18-secret/music_box.runs/player_clock_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log player_clock.vds -m64 -mode batch -messageDb vivado.pb -notrace -source player_clock.tcl
