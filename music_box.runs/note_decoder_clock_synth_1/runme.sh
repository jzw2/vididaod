...
HD_PWD='/home/kristbp2/cs296-33fa18-secret/music_box.runs/note_decoder_clock_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log note_decoder_clock.vds -m64 -mode batch -messageDb vivado.pb -notrace -source note_decoder_clock.tcl
